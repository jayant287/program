...
$.extend(Controller, {
    gridSize: [36, 20], // 36, 24 number of nodes horizontally and vertically
    ...
    onsearch: function(event, from, to) {
        ...
        console.log("tart position ",this.startX,this.startY)
    ...
    hookPathFinding: function() {
        ...
        PF.Node.prototype = {
            ...
            set opened(v) {
                this._opened = v;
                console.log("values of v is ",v, this.x, this.y)
